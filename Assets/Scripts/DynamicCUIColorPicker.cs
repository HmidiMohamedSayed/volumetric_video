...
public class DynamicCUIColorPicker : MonoBehaviour
{
    ...
    private void Setup( Color inputColor )
    {
        ...
        Action applySaturationValue = () => {
            ...
            if ( _color != resultColor ) {
                ...
                _color = resultColor;
                DynamicUIManager.shader.material.SetVector("_Tint",Color);
            }
        };
        applyHue();
    ...
    void Awake()
    {
        if(DynamicUIManager.shader != null)
        {
            Color = DynamicUIManager.shader.material.GetVector("_Tint");
        }
        else
        {
            Color = Color.red;
    ...
    {
        DynamicUIManager.shader.material.SetVector("_Tint", new Vector4(0.5f, 0.5f, 0.5f, 1f));
