...
public class CUIColorPicker : MonoBehaviour
{
    ...
    private void Setup( Color inputColor )
    {
        ...
        Action applySaturationValue = () => {
            ...
            if ( _color != resultColor ) {
                ...
                _color = resultColor;
                UIManager.shader.material.SetVector("_Tint",Color);
            }
        };
        applyHue();
    ...
    void Awake()
    {
        if(UIManager.shader != null)
        {
            Color = UIManager.shader.material.GetVector("_Tint");
        }
        else
        {
            Color = Color.red;
    ...
    {
        UIManager.shader.material.SetVector("_Tint", new Vector4(0.5f, 0.5f, 0.5f, 1f));
